      ...
      >
        ...
        >
          <el-upload
            ...
            <img v-if="form.plant_img" :src="form.plant_img" class="avatar">
      ...
      handleSubmit(e: any) {
        ...
        formRef.validate((valid: boolean) => {
          if (valid) {
            ...
            let info: any = {}
            info.plant_name = this.form.plant_name
            info.plant_img = this.form.plant_img
            info.plant_number = this.form.plant_number
            info.plant_html = this.editor.txt.html()

            console.log(info, 'infoinfoinfo')
            this.$store.dispatch('rule/add', info)
              .then(() => {
      ...
      beforeAvatarUpload(file: any) {
        ...
        getQiniu().then(response => {
          ...
          axios.post('https://up-z2.qiniup.com', formData).then(e => {
            this.form.plant_img = response.data.bucket_domain + e.data.key
          })
        })
